...
function App() {
  ...
  const elements = [
    ...
    { data: { id: 'h1c1', parent: 'host1', type: 'ellipse', label: 'core 1' }, position: { x: 215, y: 5 }, style: { 'background-color': 'red' } },
    ...
    { data: { id: 'h1c4', parent: 'host1', type: 'ellipse', label: 'core 4' }, position: { x: 265, y: 55 }, style: { 'background-color': 'blue' } },
    ...
    { data: { id: 'connection', type: 'diamond', label: '' }, position: { x: 500, y: 75 }, style: { 'background-color': 'purple' } },
